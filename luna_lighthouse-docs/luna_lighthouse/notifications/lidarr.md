...
Once setup, close LunaLighthouse and run the webhook test in Lidarr. You should receive a new notification letting you know that LunaLighthouse is ready to receive Lidarr notifications!
