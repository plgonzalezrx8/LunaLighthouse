...
In Tautulli's web GUI, head to Settings -> Notification Agents, hit the "Add a new notification agent" button and select "LunaLighthouse". Please follow each section below to setup the webhook:

{% tabs %}
{% tab title="Configuration" %}
**LunaLighthouse Webhook URL**

Paste the full device-based or user-based URL that was copied from LunaLighthouse.

**LunaLighthouse Profile**

Enter in the name of the profile which should be an **exact match** to the profile that this module instance was added to within LunaLighthouse. Capitalization and punctuation _does_ matter.
...
Once setup, close LunaLighthouse and run the webhook test in Tautulli. You should receive a new notification letting you know that LunaLighthouse is ready to receive Tautulli notifications!
