...
import 'package:luna_lighthouse/database/models/log.dart';
import 'package:luna_lighthouse/database/models/profile.dart';
import 'package:luna_lighthouse/types/indexer_icon.dart';
...
enum LunaLighthouseDatabase<T> with LunaTableMixin<T> {
  ...
  @override
  LunaTable get table => LunaTable.luna_lighthouse;

  @override
  final T fallback;

  const LunaLighthouseDatabase(this.fallback);
  ...
  @override
  dynamic export() {
    LunaLighthouseDatabase db = this;
    switch (db) {
      case LunaLighthouseDatabase.DRAWER_MANUAL_ORDER:
