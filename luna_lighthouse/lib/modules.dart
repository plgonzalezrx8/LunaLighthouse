...
extension LunaModuleMetadataExtension on LunaModule {
  String get title {
    switch (this) {
      case LunaModule.DASHBOARD:
        return 'luna_lighthouse.Dashboard'.tr();
      case LunaModule.LIDARR:
        return 'Lidarr';
      case LunaModule.NZBGET:
        return 'NZBGet';
      ...
      case LunaModule.SETTINGS:
        return 'luna_lighthouse.Settings'.tr();
      case LunaModule.SONARR:
        return 'Sonarr';
      case LunaModule.TAUTULLI:
        return 'Tautulli';
      ...
      case LunaModule.WAKE_ON_LAN:
        return 'Wake on LAN';
      case LunaModule.EXTERNAL_MODULES:
        return 'luna_lighthouse.ExternalModules'.tr();
    }
  }
  ...
  String get description {
    switch (this) {
      ...
      case LunaModule.SETTINGS:
        return 'Configure LunaLighthouse';
      case LunaModule.SONARR:
  ...
  String? get information {
    switch (this) {
      ...
      case LunaModule.SEARCH:
        return 'LunaLighthouse currently supports all indexers that support the newznab protocol, including NZBHydra2.';
      case LunaModule.SETTINGS:
        return null;
      case LunaModule.SONARR:
      ...
      case LunaModule.EXTERNAL_MODULES:
        return 'LunaLighthouse allows you to add links to additional modules that are not currently supported allowing you to open the module\'s web GUI without having to leave LunaLighthouse!';
    }
  }
}
...
extension LunaModuleWebhookExtension on LunaModule {
  ...
  String? get webhookDocs {
    ...
    switch (this) {
      case LunaModule.LIDARR:
        return 'https://docs.lunalighthouse.app/lunalighthouse/notifications/lidarr';
      case LunaModule.RADARR:
        return 'https://docs.lunalighthouse.app/lunalighthouse/notifications/radarr';
      case LunaModule.SONARR:
        return 'https://docs.lunalighthouse.app/lunalighthouse/notifications/sonarr';
      case LunaModule.OVERSEERR:
        return 'https://docs.lunalighthouse.app/lunalighthouse/notifications/overseerr';
      case LunaModule.TAUTULLI:
        return 'https://docs.lunalighthouse.app/lunalighthouse/notifications/tautulli';
      default:
        return null;
    }
  }
...
extension LunaModuleExtension on LunaModule {
  ...
  Widget informationBanner() {
    String key = 'LUNALIGHTHOUSE_MODULE_INFORMATION_${this.key}';
          ...
          return LunaBanner(
            ...
            buttons: [
              ...
              if (this.website != null)
                LunaButton.text(
                  text: 'luna_lighthouse.Website'.tr(),
