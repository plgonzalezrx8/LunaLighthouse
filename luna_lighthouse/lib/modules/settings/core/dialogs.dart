...
import 'package:luna_lighthouse/modules/dashboard/core/adapters/calendar_starting_day.dart';
import 'package:luna_lighthouse/modules/dashboard/core/adapters/calendar_starting_size.dart';
import 'package:luna_lighthouse/modules/dashboard/core/adapters/calendar_starting_type.dart';
import 'package:luna_lighthouse/modules/settings/core/types/header.dart';
import 'package:luna_lighthouse/system/state.dart';
import 'package:luna_lighthouse/utils/validator.dart';
...
class SettingsDialogs {
  ...
  Future<bool> deleteIndexer(BuildContext context) async {
    ...
    await LunaDialog.dialog(
      ...
      buttons: [
        LunaDialog.button(
          text: 'luna_lighthouse.Delete'.tr(),
          textColor: LunaColours.red,
          onPressed: () => _setValues(true),
        ),
      ],
  ...
  Future<Tuple2<bool, String>> renameProfileSelected(
    ...
    await LunaDialog.dialog(
      ...
      buttons: [
        LunaDialog.button(
            text: 'luna_lighthouse.Rename'.tr(),
            onPressed: () => _setValues(true),
  ...
  Future<bool> dismissTooltipBanners(BuildContext context) async {
    ...
    await LunaDialog.dialog(
      ...
      buttons: [
        LunaDialog.button(
          text: 'luna_lighthouse.Dismiss'.tr(),
          textColor: LunaColours.red,
          onPressed: () => _setValues(true),
        ),
      ],
  ...
  Future<Tuple2<bool, String>> decryptBackup(BuildContext context) async {
    ...
    await LunaDialog.dialog(
      ...
      buttons: [
        LunaDialog.button(
          text: 'luna_lighthouse.Restore'.tr(),
          onPressed: () => _setValues(true),
        ),
      ],
      content: [
  ...
  Future<Tuple2<bool, String>> backupConfiguration(BuildContext context) async {
    ...
    await LunaDialog.dialog(
      ...
      buttons: [
        LunaDialog.button(
          text: 'luna_lighthouse.BackUp'.tr(),
          textColor: LunaColours.accent,
          onPressed: () => _setValues(true),
        ),
      ],
