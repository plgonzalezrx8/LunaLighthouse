...
import 'package:luna_lighthouse/modules/settings/routes/configuration/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_general/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_dashboard/pages/calendar_settings.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_dashboard/pages/default_pages.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_dashboard/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_drawer/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_external_modules/pages/add_module.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_external_modules/pages/edit_module.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_external_modules/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_lidarr/pages/connection_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_lidarr/pages/default_pages.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_lidarr/pages/headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_lidarr/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_nzbget/pages/connection_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_nzbget/pages/default_pages.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_nzbget/pages/headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_nzbget/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_quick_actions/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_radarr/pages/connection_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_radarr/pages/default_options.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_radarr/pages/default_pages.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_radarr/pages/headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_radarr/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sabnzbd/pages/connection_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sabnzbd/pages/default_pages.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sabnzbd/pages/headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sabnzbd/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_search/pages/add_indexer.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_search/pages/add_indexer_headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_search/pages/edit_indexer.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_search/pages/edit_indexer_headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_search/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sonarr/pages/connection_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sonarr/pages/default_options.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sonarr/pages/default_pages.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sonarr/pages/headers.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_sonarr/route.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_tautulli/pages/connection_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/configuration_tautulli/pages/default_pages.dart';
...
import 'package:luna_lighthouse/modules/settings/routes/system_logs/pages/log_details.dart';
import 'package:luna_lighthouse/modules/settings/routes/system_logs/route.dart';
import 'package:luna_lighthouse/router/routes.dart';
import 'package:luna_lighthouse/types/log_type.dart';
...
enum SettingsRoutes with LunaRoutesMixin {
  ...
  GoRoute get routes {
    switch (this) {
      ...
      case SettingsRoutes.COMING_SOON:
        return route(widget: const ComingSoonRoute());
    ...
    switch (this) {
      case SettingsRoutes.HOME:
        return [
          ...
          SettingsRoutes.COMING_SOON.routes,
