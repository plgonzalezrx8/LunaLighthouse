...
import 'package:luna_lighthouse/system/flavor.dart';
  ...
  String get title {
    switch (this) {
      case LunaLogType.WARNING:
        return 'luna_lighthouse.Warning'.tr();
      case LunaLogType.ERROR:
        return 'luna_lighthouse.Error'.tr();
      case LunaLogType.CRITICAL:
        return 'luna_lighthouse.Critical'.tr();
      case LunaLogType.DEBUG:
        return 'luna_lighthouse.Debug'.tr();
    }
  }
