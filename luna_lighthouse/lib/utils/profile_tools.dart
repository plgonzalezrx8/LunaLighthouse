...
class LunaProfileTools {
  bool changeTo(
    ...
    try {
      if (LunaLighthouseDatabase.ENABLED_PROFILE.read() == profile) return true;
      _changeTo(profile);
  ...
  void _changeTo(String profile) {
    ...
    LunaLighthouseDatabase.ENABLED_PROFILE.update(profile);
    LunaState.reset();
  }
  ...
  Future<void> _remove(String profile) async {
    if (LunaLighthouseDatabase.ENABLED_PROFILE.read() == profile) {
