...
class LunaMessage extends StatelessWidget {
  ...
  factory LunaMessage.goBack({
    ...
    return LunaMessage(
      key: key,
      text: text,
      buttonText: 'luna_lighthouse.GoBack'.tr(),
      onTap: () {
  ...
  factory LunaMessage.error({
    ...
    return LunaMessage(
      ...
      buttonText: 'luna_lighthouse.TryAgain'.tr(),
      onTap: onTap,
      useSafeArea: useSafeArea,
    );
  }
  ...
  factory LunaMessage.moduleNotEnabled({
    ...
    return LunaMessage(
      key: key,
      text: 'luna_lighthouse.ModuleIsNotEnabled'.tr(args: [module]),
      buttonText: 'luna_lighthouse.ReturnToDashboard'.tr(),
