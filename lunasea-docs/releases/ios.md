...
Lunarr is available on iOS 11.0+.

Note that installation of iOS app package (`.ipa`) files is a relatively advanced task and instructions are outside the scope of Lunarr's documentation and no support will be provided.
...
The easiest way for most users with iOS devices who want stable releases would be to download releases of Lunarr directly from the [App Store](https://www.lunarr.app/appstore)!
...
All iOS releases are available in the [Build Bucket](https://builds.lunarr.app/#latest/)!
